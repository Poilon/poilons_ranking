...
ActiveRecord::Schema.define(version: 20150203065710) do
  ...
  create_table "alternate_nicknames", force: true do |t|
    t.integer "participant_id"
    t.string  "name"
    t.integer "game_id"
  end

  create_table "character_participants", force: true do |t|
    t.integer "participant_id"
